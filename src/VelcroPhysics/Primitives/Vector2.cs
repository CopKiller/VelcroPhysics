...
public struct Vector2 : IEquatable<Vector2>
{
    ...
    ///     <see cref="MathHelper.LerpPrecise" /> on MathHelper for the interpolation. Less efficient but more precise compared
    ///     to
    ///     <see cref="Vector2.Lerp(Vector2, Vector2, float)" />. See remarks section of <see cref="MathHelper.LerpPrecise" />
    ///     on
