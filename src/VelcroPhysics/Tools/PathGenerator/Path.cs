...
namespace Genbox.VelcroPhysics.Tools.PathGenerator
{
    ...
    public class Path
    {
        ...
        {
            ExtensionsMatrix4X4.CreateRotationZ(value, out Matrix4x4 rotationMatrix);
        ...
        public Vector2 GetPosition(float time)
        {
            ...
            if (Closed)
            {
                ...
                temp = ExtensionsVector2.CatmullRom(ControlPoints[p0], ControlPoints[p1], ControlPoints[p2], ControlPoints[p3], lt);
        ...
        public Vector2 GetPositionNormal(float time)
        {
            ...
            ExtensionsVector2.Subtract(ref a, ref b, out Vector2 temp);

            Vector2 output = new Vector2();
            output.X = -temp.Y;
            output.Y = temp.X;
            
            ExtensionsVector2.Normalize(ref output, out output);
