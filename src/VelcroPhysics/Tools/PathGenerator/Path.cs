...
public class Path
{
    ...
    {
        for (var i = 0; i < ControlPoints.Count; i++) ControlPoints[i] = Vector2.Add(ControlPoints[i], vector);
    }
    ...
    {
        for (var i = 0; i < ControlPoints.Count; i++) ControlPoints[i] = Vector2.Multiply(ControlPoints[i], value);
    }
