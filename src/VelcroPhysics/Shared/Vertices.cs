...
public class Vertices : List<Vector2>
{
    ...
    public void Translate(ref Vector2 value)
    {
        ...
        for (var i = 0; i < Count; i++) this[i] = Vector2.Add(this[i], value);
    ...
    public void Scale(ref Vector2 value)
    {
        ...
        for (var i = 0; i < Count; i++) this[i] = Vector2.Multiply(this[i], value);
    ...
    public void Transform(ref Matrix transform)
    {
        ...
        for (var i = 0; i < Count; i++) this[i] = Vector2.Transform(this[i], transform);
    ...
    {
        for (var i = 0; i < Count; i++) this[i] = new Vector2(-1 * this[i].X, this[i].Y);
    }

    public void FlipVertically()
    {
        for (var i = 0; i < Count; i++) this[i] = new Vector2(this[i].X, -1 * this[i].Y);
    }
