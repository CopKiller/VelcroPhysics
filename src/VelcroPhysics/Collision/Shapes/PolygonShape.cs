...
public class PolygonShape : Shape
{
    ...
    private void SetVertices(Vertices vertices)
    {
        ...
        // Copy vertices.
        for (var i = 0; i < m; ++i) _vertices.Add(ps[hull[i]]);
    ...
    protected sealed override void ComputeProperties()
    {
        ...
        _massData._inertia += _massData._mass *
                              (MathUtils.Dot(_massData._centroid, _massData._centroid) - MathUtils.Dot(center, center));
    }
