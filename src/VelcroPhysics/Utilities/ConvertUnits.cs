...
namespace Genbox.VelcroPhysics.Utilities
{
    ...
    public static class ConvertUnits
    {
        ...
        {
            ExtensionsVector2.Multiply(ref simUnits, _displayUnitsToSimUnitsRatio, out displayUnits);
        }
        ...
        {
            ExtensionsVector2.Multiply(ref displayUnits, _simUnitsToDisplayUnitsRatio, out simUnits);
        }
