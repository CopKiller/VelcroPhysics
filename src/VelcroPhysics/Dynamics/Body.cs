...
public class Body
{
    ...
    public bool Enabled
    {
        ...
        set
        {
            ...
            if (value)
            {
                ...
                // Create all proxies.
                var broadPhase = _world.ContactManager.BroadPhase;
                for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].CreateProxies(broadPhase, ref _xf);
            ...
            else
            {
                ...
                for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].DestroyProxies(broadPhase);
    ...
    public float Restitution
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].Restitution = value;
        }
    }
    ...
    public float Friction
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].Friction = value;
        }
    }
    ...
    public Category CollisionCategories
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].CollisionCategories = value;
        }
    }
    ...
    public Category CollidesWith
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].CollidesWith = value;
        }
    }
    ...
    public Category IgnoreCCDWith
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].IgnoreCcdWith = value;
        }
    }
    ...
    public short CollisionGroup
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].CollisionGroup = value;
        }
    }
    ...
    public bool IsSensor
    {
        set
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].IsSensor = value;
        }
    }
    ...
    public Fixture AddFixture(FixtureDef def)
    {
        ...
        if (fixture._shape._density > 0.0f) ResetMassData();
    ...
    public void SetTransform(ref Vector2 position, float rotation)
    {
        ...
        var broadPhase = _world.ContactManager.BroadPhase;
        for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].Synchronize(broadPhase, ref _xf, ref _xf);
    ...
    internal void SynchronizeFixtures()
    {
        ...
        if ((_flags & BodyFlags.AwakeFlag) == BodyFlags.AwakeFlag)
        {
            ...
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].Synchronize(broadPhase, ref xf1, ref _xf);
        }
        else
        {
            for (var i = 0; i < _fixtureList.Count; i++) _fixtureList[i].Synchronize(broadPhase, ref _xf, ref _xf);
